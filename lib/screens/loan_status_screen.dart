          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                _TrackStep('Application Submitted', true, false),
                _TrackStep('Document Verification', true, false),
                _TrackStep('Gold Appraisal', true, false),
                _TrackStep('Loan Sanctioned', true, false),
                _TrackStep('Amount Disbursed', true, false),
              ],
            ),
          ),
        ],
